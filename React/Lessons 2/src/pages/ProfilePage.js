...
const profileSchema = z.object({
    ...
    lastName: z
        .string()
        .min(2, "Призвище має мати щонайменше 2 символи")
        .max(50, "Призвище занадто довге"),
        ...
        <>
            ...
            <div className="container mt-2">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="col-md-6 offset-md-3">
                    ...
                    {/* Призвище */}
                    <div className="mb-3">
                        <label htmlFor="lastName" className="form-label">Призвище</label>
                        <input
                            type="text"
                            className={`form-control ${errors.firstName ? "is-invalid" : ""}`}
                            id="lastName"
                    ...
                    {/* Пошта */}
                    <div className="mb-3">
                        <label htmlFor="email" className="form-label">Електронна адреса</label>
                        <input
                            type="text"
                            className={`form-control ${errors.firstName ? "is-invalid" : ""}`}
                            id="email"
                            placeholder="pinkiepie@gmail.com"
                            {...register("email")}
                        />
